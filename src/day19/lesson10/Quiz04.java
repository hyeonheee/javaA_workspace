...
public class Quiz04 {
    public static void main(String[] args) {
        ...
        while (iter.hasNext()) {
            ...
            //System.out.println(bookMap.get(genre)); 장르가 나온다
...
//            if (bookMap.get(name).containsKey(searchBook)) {
//                System.out.println(searchBook + "의 작가명은 " + bookMap.get(name).get(searchBook));
//            } else {
